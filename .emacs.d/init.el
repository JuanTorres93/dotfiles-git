...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dired-single company-lsp pyvenv haskell-mode lsp-python-ms dap-mode lsp-gdscript-port evil-nerd-commenter lsp-ui company-box undo-tree evil-magit counsel-projectile projectile helpful counsel ivy-rich centaur-tabs doom-modeline lsp-mode magit evil-org-mode gdscript-mode evil-org ## rust-mode auctex yasnippet-snippets yasnippet yasnippets swiper powerline-evil evil evil-mode popup-kill-ring powerline company dashboard rainbow-delimiters sudo-edit rainbow-mode avy smex ido-vertical-mode org-ac beacon which-key use-package doom-themes))
