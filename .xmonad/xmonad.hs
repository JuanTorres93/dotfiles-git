...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Trading
    , ((modm .|. controlMask .|. shiftMask .|. altMask, xK_b     ), spawn (myBrowser ++ " https://www.binance.com/en/markets/newListing https://www.binance.com/en/my/orders/exchange/tradeorder https://www.tradingview.com/chart/E7Os5wqY/?symbol=BINANCE%3ABTCEUR https://coinmarketcap.com/es/?page=5 https://miro.medium.com/v2/resize:fit:2000/0*fGOH_EZ-GIQ3EePJ"))
